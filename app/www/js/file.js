...
$(document).ready(function() {
    ...
    //     </div>
    // </div>
    fileDom = function(message, isUpload, isMain, uploadId, url) {
        // 时间dom
    ...
    $("#file_copy").on("click", function() {
        ...
        fileInput.onchange = function() {
            ...
            //添加dom
            var dom = fileDom({fileName:file.name,createTime:(new Date()).valueOf()}, true, true, xhr.currentUploadFileId, "javascript:;");
